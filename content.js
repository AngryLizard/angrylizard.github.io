contentObject = {
    ...
    [
            ...
            [
                {
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            caption: "With the character's core being physically simulated, we can easily apply external forces and make the characters react to outside influences."
                        },
                        {
                        ...
                        },
                        {
                            ...
                            caption: "To compute drag, an approximation of the character's surface area as well as the surrounding substance density is used."
                        },
                    ]
                },
                {
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            caption: "Anatomy is customised by changing the initial transform of the bones. This can be leg or arm lengths, changes in posture or even species."
                        },
                        {
                    ...
                    [
                        {
                            ...
                            caption: "With the new Unreal Engine Control Rig system came the ability to make custom animation rigs using C++. Most aspects of the showcased rig were done using custom tools, such as custom leg IK, arm IK and spine IK."
                        },
                        {
                        ...
                        },
                        {
                            ...
                            caption: "All beforementioned modifiers and some smaller qualitiy-of-life improvements make this rig very easy to use and fast to animate."
                        },
                        {
                    ...
                    [
                        {
                            ...
                            caption: "Usually AI navigates through a level using nav-mesh, but we needed obstacle detection that worked for more dynamic situations (and upside down). This system does line-traces every X ticks to survey the environment and keeps track of obstacles it found."
                        },
                        {
                ...
                },
                {
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            caption: "An achievement system tracks the progress of the player and rewards them with unlocks if their current task is fulfilled. All game systems record stats the achievements can be evaluated with, such as \"meters walked\" or \"degrees turned\". The achievement tree is generated procedurally on a 2D grid using A* search."
                        },
                        {
                            content: "./content/interactionSystem/slide3.gif",
                            caption: "Characters have stats (such as health or stamina) that are affected by environmental interactions such as items being consumed or damage taken. If the stats reach a certain threshold a buff/debuff is applied to the character that impact them in some way, for example slower movement or specific actions being unavailable while active."
                        },
                    ]
                },
                {
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            caption: "Delaunay triangulation for less mesh strain."
                        },
                        {
                    ...
                    [
                        {
                            ...
                            caption: "Game loading system that saves and loads the whole world, allowing to open different profiles. The save-system is custom and reloads as few assets as possible, making loading another profile seamless. The world system consists of multiple dimensions that can be travelled between seamlessly. Dimensions with players remain loaded on the server, clients can be in different dimensions at the same time."
                        },
                        {
        ...
        {
            name: "Game Projects",
            description: "Gamejam projects done outside of Unreal Engine",
            projects:
            [
                {
                    ...
                    [
                        {
                            ...
                            caption: "Game project done in a team of 5 made in Monogame. In local multiplayer with up to 4 players, the goal is to keep the Circus train going for as long as possible. Fulfil different tasks and make enough money during the performance phase. In this project I've provided all the deferred rendering pipeline, rendering logic and graphics."
                        },
                        {
                        ...
                        },
                        {
                            ...
                            caption: "There is a lot of platforming, movement has to feel good and snappy. Character deformation while running, falling or impact sells the movement."
                        },
                        {
                        ...
                        },
                        {
                            ...
                            caption: "Shading is computed dynamically using ray-marching via compute shader."
                        },
                        {
                    ...
                    [
                        {
                            ...
                            caption: "One month long Gamejam project, platformer with interactive elements. I was responsible for the movement system, animations and gameplay mechanics. None of the mesh assets shown were made by me."
                        },
                        {
                    ...
                    [
                        {
                            ...
                            caption: "Modular character menu system made for Second Life in the very limited LSL syntax. Supports colours, bars, combo boxes and asset selection. Can load multiple layers and save states. None of the 2D assets shown were made by me."
                        },
                    ]
                },
            ]
            ...
            [
                {
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            caption: "Foot step generation uses a mirrored sigmoid curve for the step, step pattern is user defined."
                        },
                        {
                            content: "./content/locomotion/slide4.gif",
                            caption: "Trajectory of pelvis is optimized so that the character's center of pressure is always inside the polygon spanned by the character's feet (support polygon)."
                        },
                        {
                ...
                },
                {
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            caption: "After unwrapping a mesh (greedy algorithm) it can be sliced into shells where the mesh edges are think enough to ben. The resulting print can be folded back to the original shape."
                        },
                        {
